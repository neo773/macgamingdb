...
const APPLE_BUTTON_BASE_STYLE: React.CSSProperties = {
  fontSynthesis: 'none',
  ...
  return (
    ...
    >
      <div
        ...
        style={{ ...APPLE_BUTTON_BASE_STYLE, opacity: hovered ? 0.85 : 1 }}
        role="button"
        tabIndex={0}
          ...
          >
            <g>
              <svg
                ...
                height="50%"
                y="25%"
                viewBox="0 -11 123.6875 14"
                fill="#000"
              >
                <defs>
                  <style
                    // eslint-disable-next-line react/no-danger -- Apple Sign-In requires inline @font-face from base64 woff per official spec
