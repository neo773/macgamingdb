          ...
          <div className="relative mb-8">
            <div className="aspect-[3/1] rounded-xl overflow-hidden relative ring-1 ring-gray-800 shadow-lg shadow-blue-900/20">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                ...
                {game.release_date && (
                  <p className="text-gray-300">Released: {game.release_date.date}</p>
                )}
              </div>
            </div>
          </div>
              ...
              <Card className="bg-gray-900 border-gray-800 shadow-lg mb-8">
                ...
                <CardContent>
                  {stats ? (
                    <>
                      <div className="mb-6">
                        <h3 className="text-lg font-medium mb-2 text-gray-300">Experience Reports</h3>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-white">{stats.averagePerformance.toFixed(1)}/4</span>
                        </div>
                      </div>
                    </>
                  ) : (
                  ...
                  {reviews.map((review) => (
                    <div key={review.id} className="border-b border-gray-800 pb-6 last:border-0">
                      <div className="flex flex-wrap justify-between mb-4">
                        <div>
                          <span className="font-medium text-gray-300 mr-2">Method:</span>
                          <span className="bg-blue-900 text-blue-100 text-xs px-2 py-1 rounded">
                            {formatMethodName(review.playMethod)}
                          </span>
                          
                          {review.translationLayer && (
                            <span className="ml-2 bg-purple-900 text-purple-100 text-xs px-2 py-1 rounded">
                              {review.translationLayer}
                            </span>
                          )}
                        </div>
                        <div>
                          <span className="font-medium text-gray-300 mr-2">Performance:</span>
                          <span className={`text-xs px-2 py-1 rounded ${getPerformanceColor(review.performance)}`}>
