      ...
      <div className="max-w-7xl w-full">
        <div className="flex items-center justify-between mb-6">
          <Link href={"/"} className="flex items-center">
            ...
            <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-400">MacGamingDB</h1>
          </Link>
          <Acccount />
        </div>
        <p className="text-xl text-gray-300 mb-6 mx-auto text-center">
