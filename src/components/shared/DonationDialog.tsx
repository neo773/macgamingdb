    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 rounded-lg overflow-hidden">
        <div className="flex items-center justify-center">
          <a
            href="https://www.paypal.com/paypalme/huzef32"
            className="bg-[#FFC43A] rounded-sm p-2 w-[200px] flex items-center justify-center hover:bg-[#FFC43A]/80 transition-all duration-300"
            target="_blank"
          >
            <img
